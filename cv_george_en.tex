...
\begin{itemize}
\item F\'abrega, J., \& {\bf Vega, G.} (forthcoming) El impacto del rating televisivo sobre la actividad en Twitter: Evidencia para Chile. In {\it Cuadernos.info}.
...
%\item ``blopmatching: Implementing a New Matching Estimator based on a Bi-Level Optimization Problem'', on development.

...
\def\footerlink{http://cana.usc.edu/vegayon}
...
\begin{minipage}{0.45\linewidth}
  \begin{tabular}{>{\bfseries}p{4cm}l}
    ...
    website & \href{http://cana.usc.edu/vegayon}{\tt http://cana.usc.edu/vegayon} \\
...
\begin{itemize}
\item {\bf M.Sc. in Social Sciences (Economics)} California Institute of Technology (2016) \\
...
\begin{itemize}
\item \textbf{University of Southern California, 2015--present} Department of Preventive Medicine \emph{Research Programmer}. Development and Implementation of statistical methods using R, funded by National Cancer Institute and NIH.
...
\item \textbf{Misc} Founder of the R Users Group in Chile (2013).

...
\begin{itemize}
\item 
{\bf Ph.D. in Biostatistics (Estad\'istica Computacional)} University of Southern California (2020). T\'esis \emph{``Essays on Bioinformatics and Social Network Analysis: Statistical and Computational Methods for Complex Systems''}

{\bf M.Sc. in Social Sciences (Econom\'ia)} California Institute of Technology (2016)

{\bf Magister en Economía y Políticas Públicas}, Universidad Adolfo Ibáñez (2011)

{\bf Ingeniería Comercial}, Universidad Adolfo Ibáñez (2010)
\end{itemize}

\section*{Experiencia Profesional}

\begin{itemize}
\item \textbf{University of Southern California, EE.UU., 2015--presente} Department of Preventive Medicine \emph{Research Programmer II}. Staff académico senior, mis responsabilidades incluyen: Soporte técnico en estadística computacional, ej., HPC, capacitar en temas de desarrollo de software científico y realizar investigación científica. Desde Agosto del 2020 soy co-instructor del curso ``Introduction to Data Science'' para el magister en ``Health Data Science.''
\item \textbf{Superintendencia de Pensiones, Chile, Agosto 2011-- Agosto 2014} \emph{Analista} de la División de Investigación. Análisis estadístico y econométrico del seguro de desempleo, desarollo de software, puente entre las divisiones de TI e Investigación.
\item \textbf{Nodos Chile Social Network Analysis Ltda., Chile, Enero 2012--Enero 2014} \emph{Socio}.
Socio fundador de una de las primeras consultoras de redes sociales en Chile.
\item \textbf{Universidad Adolfo Ibáñez, Chile, Enero 2011--Junio 2012.} Escuela de Gobierno \emph{Profesor part-time}.
Enseñé cursos de Introducción a la Economía, Microeconomía y Estadística computacional con Stata.
\item \textbf{Ministerio de Desarrollo Social, Chile, Marzo 2011--Diciembre2011.} \textit{Analista} Monitoreo de Programas Sociales.
Levantamiento y Análisis de los programas sociales ofrecidos por el gobierno y soporte a la Iniciativa de Datos Abiertos de la división.
\end{itemize}

\section*{Software {\small (subset)}}
...
\section*{Publicaciones Académicas {\small (subset)}}
...
\begin{itemize}
\item \textbf{Tecnología} R, C++, \LaTeX, SQL, python, XML, regex, Stata, VBA, Gephi, Pajek, Mathematica, git, unix.
...
\item \textbf{Premios} Travel Grant, Society of Young Network Scientist, 2019; Fellowship, California Institute of Technology, 2014; Scholarship, Adolfo Ib\'a\~nes University, 2006.
...
\item \textbf{Journal reviewer} The Official Journal of The Society for Computational Economics, The R Journal, Social Networks, Journal of Mathematical Sociology, Journal of Open Source Software, SUNBELT Conference (2016), International Conference on Computational Social Science (2019).
\item \textbf{Comunidad} Fundador del \href{https://www.meetup.com/useRchile/}{Grupo de Usuarios de R en Chile (2013)}, co-organizador del \href{https://socalr.org}{East LA R User Group (LAERUG)}.

...
\begin{tikzpicture}[remember picture, overlay]
	\node[anchor=north east, inner sep=30pt] at (current page.north east) {\includegraphics[width=0.4\textwidth]{fig/ukfaculty.pdf}};
\end{tikzpicture}
...
\begin{itemize}
	...
	\item[-] Wrote scientific papers and software on network science and presented them at conferences.

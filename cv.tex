...
\usepackage{hyperref}
\usepackage{geometry}
\usepackage[minbibnames=3,sorting=ydnt,date=comp,isbn=false,doi=false,defernumbers=true,backend=biber]{biblatex}
...
Dissertation \emph{``Essays on Bioinformatics and Social Network Analysis: Statistical and Computational Methods for Complex Systems''}
...
\item {\bf BS. in Social Sciences} and {\bf BS. in Business Administration} (with a minor in Political Science) (2010)\\Adolfo Ib\'a\~nez University, Chile
\end{itemize}
...
\printbibliography[title=\vskip-20pt,nottype=inproceedings,resetnumbers=true]
...
\printbibliography[title=\vskip-20pt,type=inproceedings,resetnumbers=true]
